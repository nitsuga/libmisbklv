...
inline constexpr ItemDescriptor vmti_0903_items[] = {
    ...
    { .tag = 4, .name = "VMTI LS Version Number", .units = "", .kind = ValueKind::UInt, .variable = true, .fixed_len = 2, .is_signed = false, .map = {0.0, 0.0}, .specials = {}, .flags = kNone, .child = RegistryId::None },
    { .tag = 5, .name = "Total Number of Targets Detected", .units = "", .kind = ValueKind::UInt, .variable = true, .fixed_len = 3, .is_signed = false, .map = {0.0, 0.0}, .specials = {}, .flags = kNone, .child = RegistryId::None },
    { .tag = 6, .name = "Number of Reported Targets", .units = "", .kind = ValueKind::UInt, .variable = true, .fixed_len = 3, .is_signed = false, .map = {0.0, 0.0}, .specials = {}, .flags = kNone, .child = RegistryId::None },
